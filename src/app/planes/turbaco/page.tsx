...
export const metadata: Metadata = {
  ...
  description: "Planes de previsión exequial en Turbaco. Parque Cementerio Jardín Los Olivos. Protección integral para tu familia.",
}
...
const planes = [
  {
    title: "Plan Básico",
    price: "$14.800",
    description: "Incluye titular con edad de ingreso hasta 65 años y sin límite de edad de permanencia. Puede incluir: 2 personas hasta los 75 años y 4 personas hasta los 50 años. Todos los beneficiarios son sin límite de edad para permanencia. Sin destino final.",
    popular: false,
  },
  {
    title: "Plan Integral",
  ...
  },
  {
    ...
    price: "$31.800",
    description: "Ideal para todos los miembros de tu familia. Titular menor a 65 años. Podrás incluir a 2 adultos mayores hasta 80 años y a 4 personas menores a 50 años, sin importar lazos de consanguinidad o afinidad.",
    popular: false,
  },
  {
    title: "Plan 6+1 Sin Destino Final",
    price: "$19.100",
    description: "Incluye titular con edad de ingreso hasta 65 años. 2 beneficiarios hasta 75 años y 4 hasta los 60 años, sin importar lazos de consanguinidad. No incluye destino final.",
    popular: false,
  },
  {
    title: "Plan Unidos 6+1",
    price: "$29.700",
    description: "Incluye titular con edad de ingreso hasta 65 años. 2 beneficiarios hasta 75 años y 4 hasta 60 años, sin importar el parentesco. Incluye todo lo relacionado con el homenaje, destino final y nicho a perpetuidad en nuestro Parque Cementerio Jardín Los Olivos.",
    popular: true,
  },
]
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            <div className="space-y-4 text-center lg:text-left">
              <span className="inline-flex items-center gap-1.5 text-xs font-medium bg-primary/10 text-primary px-3 py-1 rounded-full">
                <MapPin className="w-3 h-3" /> Sede Turbaco
              </span>
            ...
            <div className="relative w-2/3 sm:w-1/2 lg:w-full mx-auto">
              <Image src="/turbaco-vector.png" alt="" aria-hidden width={600} height={500} className="absolute w-full h-auto object-contain scale-[1.03] blur-2xl opacity-60 drop-shadow-[0_0_40px_rgba(206,78,88,0.4)]" />
              <Image src="/turbaco-vector.png" alt="Familia protegida con Los Olivos Turbaco" width={600} height={500} priority className="relative w-full h-auto object-contain drop-shadow-[0_20px_40px_rgba(0,0,0,0.15)]" />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col md:flex-row md:items-center gap-8 mb-8 md:mb-12">
            <div className="flex-1">
              ...
              <h2 className="font-display text-lg md:text-xl lg:text-2xl text-foreground mt-2 text-balance">Planes disponibles en Turbaco</h2>
      ...
      <section className="py-12 md:py-20 bg-primary/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-display text-2xl md:text-4xl text-foreground mb-4 text-balance font-bold">Protege a tu familia en Turbaco hoy</h2>
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              ...
              <Button size="lg" variant="outline" className="gap-2 px-8 hover:bg-primary/10 hover:border-primary hover:text-primary" asChild>
                <a href="https://wa.me/573008142820" target="_blank" rel="noopener noreferrer"><MessageCircle className="w-5 h-5" /> Contáctanos</a>
              </Button>
            </div>
