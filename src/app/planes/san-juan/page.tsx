...
export const metadata: Metadata = {
  title: "Sede San Juan - Los Olivos Cartagena",
  description:
    "Planes de previsión exequial en San Juan Nepomuceno. Protección integral para tu familia con Los Olivos.",
}
          ...
          <div className="max-w-4xl mx-auto mt-16">
            <div className="aspect-video rounded-2xl overflow-hidden shadow-lg">
              <iframe
                ...
                allowFullScreen
                title="Los Olivos - Sede San Juan"
              />
            </div>
          </div>
        </div>
