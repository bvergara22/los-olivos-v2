...
export const metadata: Metadata = {
  title: "Planes San Juan - Los Olivos Cartagena",
  description: "Planes de previsión exequial en San Juan Nepomuceno. Protección integral para tu familia con Los Olivos.",
}
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            <div className="space-y-4 text-center lg:text-left">
              <span className="inline-flex items-center gap-1.5 text-xs font-medium bg-primary/10 text-primary px-3 py-1 rounded-full">
                <MapPin className="w-3 h-3" /> Sede San Juan
              </span>
              <h1 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary leading-tight text-balance">Sede San Juan</h1>
            ...
            <div className="relative w-2/3 sm:w-1/2 lg:w-full mx-auto">
              <Image src="/san-juan-vector.png" alt="" aria-hidden width={600} height={500} className="absolute w-full h-auto object-contain scale-[1.03] blur-2xl opacity-60 drop-shadow-[0_0_40px_rgba(206,78,88,0.4)]" />
              <Image src="/san-juan-vector.png" alt="Familia protegida con Los Olivos San Juan" width={600} height={500} priority className="relative w-full h-auto object-contain drop-shadow-[0_20px_40px_rgba(0,0,0,0.15)]" />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col md:flex-row md:items-center gap-8 mb-8 md:mb-12">
            <div className="flex-1">
              ...
              <h2 className="font-display text-lg md:text-xl lg:text-2xl text-foreground mt-2 text-balance">Planes disponibles en San Juan</h2>
      ...
      <section className="py-12 md:py-20 bg-primary/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-display text-2xl md:text-4xl text-foreground mb-4 text-balance font-bold">Protege a tu familia en San Juan hoy</h2>
