  ...
  return (
    <>
      ...
      <section className="relative pt-28 pb-16 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-[3fr_2fr] gap-12 items-center">
            {/* Texto */}
            <div>
              <h1 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold text-[#240e36] leading-tight text-balance">
      ...
      <section className="py-16 md:py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <span className="text-3xl md:text-4xl text-[#3e2455] block">Horarios</span>
          </div>

          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {/* Horario de atención */}
            <div className="rounded-2xl border border-border p-6 md:p-8" style={{background: "rgba(62,36,85,0.04)"}}>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{background: "rgba(62,36,85,0.12)", color: "#3e2455"}}>
                ...
                <h3 className="font-display font-semibold text-lg" style={{color: "#240e36"}}>Horario de atención</h3>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="text-right">
                    ...
                    <span className="inline-block text-xs px-2 py-0.5 rounded-full mt-1" style={{background: "rgba(62,36,85,0.1)", color: "#3e2455"}}>Jornada continua</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Horario de visitas */}
            <div className="rounded-2xl border p-6 md:p-8" style={{background: "rgba(36,14,54,0.04)", borderColor: "rgba(62,36,85,0.2)"}}>
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style={{background: "rgba(62,36,85,0.12)", color: "#3e2455"}}>
                ...
                <h3 className="font-display font-semibold text-lg" style={{color: "#240e36"}}>Horario de visitas</h3>
              </div>
      ...
      <section className="py-16 md:py-20 bg-card relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display text-3xl md:text-4xl text-[#240e36] mb-6">
              Trámites
            </h2>

            <div className="bg-background rounded-2xl border border-border hover:border-[#3e2455]/35 transition-all p-6 md:p-8 mb-8">
              <h3 className="font-display text-lg text-[#240e36] mb-2">
              ...
              <div className="mb-6">
                <h4 className="font-display font-semibold text-[#240e36] mb-3">Documentos requeridos:</h4>
                <ul className="space-y-3">
                  {documentosRequeridos.map((doc) => (
                    <li key={doc} className="flex items-start gap-3 text-sm text-muted-foreground">
                      <CheckCircle className="w-5 h-5 flex-shrink-0 mt-0.5" style={{color: "#3e2455"}} />
                      {doc}
                    </li>
                  ))}
                </ul>
              ...
              {/* Notas importantes */}
              <div className="rounded-xl p-5 border" style={{background: "rgba(62,36,85,0.05)", borderColor: "rgba(62,36,85,0.2)"}}>
                <h4 className="font-display font-semibold text-[#240e36] mb-3">Importante:</h4>
                <ul className="space-y-3">
      ...
      <section className="py-16 md:py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <span className="text-3xl md:text-4xl text-[#3e2455] block">Nuestras opciones</span>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {productos.map((producto) => (
              <div
                key={producto.title}
                className="group bg-card rounded-2xl border border-border hover:border-[#3e2455]/40 hover:shadow-lg transition-all p-6"
              >
                ...
                <h3 className="font-display text-lg text-[#240e36] mb-2">{producto.title}</h3>
