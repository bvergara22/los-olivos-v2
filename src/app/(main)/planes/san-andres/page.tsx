        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            ...
            <div className="relative w-2/3 sm:w-1/2 lg:w-full mx-auto">
              <Image src="/san-andres-vector.webp" alt="Familia protegida con Los Olivos San Andrés" width={600} height={500} priority className="w-full h-auto object-contain" />
            </div>
          </div>
        </div>
