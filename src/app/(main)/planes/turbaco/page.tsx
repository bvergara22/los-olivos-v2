  ...
  return (
    <div className="sede-pink">
      ...
      <section className="relative pt-8 pb-12 md:pb-16 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-48 h-48 sm:w-96 sm:h-96 rounded-full bg-primary/30 translate-x-1/2 translate-y-1/2 pointer-events-none" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            ...
            <div className="relative w-2/3 sm:w-1/2 lg:w-full mx-auto">
              <Image src="/turbaco-vector.webp" alt="Familia protegida con Los Olivos Turbaco" width={600} height={500} priority className="w-full h-auto object-contain" />
            </div>
          </div>
        </div>
