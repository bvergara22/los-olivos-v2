...
export const metadata: Metadata = {
  ...
  description: "Planes de previsión exequial en Soplaviento. Protección integral para tu familia con Los Olivos.",
}
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
            <div className="space-y-4 text-center lg:text-left">
              <span className="inline-flex items-center gap-1.5 text-xs font-medium bg-primary/10 text-primary px-3 py-1 rounded-full">
                <MapPin className="w-3 h-3" /> Sede Soplaviento
              </span>
              <h1 className="font-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-primary leading-tight text-balance">Sede Soplaviento</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col md:flex-row md:items-center gap-8 mb-8 md:mb-12">
            <div className="flex-1">
              ...
              <h2 className="font-display text-lg md:text-xl lg:text-2xl text-foreground mt-2 text-balance">Planes disponibles en Soplaviento</h2>
      ...
      <section className="py-12 md:py-20 bg-primary/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-display text-2xl md:text-4xl text-foreground mb-4 text-balance font-bold">Protege a tu familia en Soplaviento hoy</h2>
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              ...
              <Button size="lg" variant="outline" className="gap-2 px-8 hover:bg-primary/10 hover:border-primary hover:text-primary" asChild>
                <a href="https://wa.me/573157006853" target="_blank" rel="noopener noreferrer"><MessageCircle className="w-5 h-5" /> Contáctanos</a>
              </Button>
            </div>
