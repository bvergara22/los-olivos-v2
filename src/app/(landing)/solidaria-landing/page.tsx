      ...
      <header className="w-full bg-white border-b border-gray-100 shadow-xl relative z-10">
        <div className="max-w-6xl mx-auto px-5 lg:px-8 h-28 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center">
            ...
            <img src="/logo-solidaria.webp" alt="Aseguradora Solidaria" className="h-32 w-auto object-contain -ml-4" />
          </div>
          {/* Right: social + phone */}
          <div className="flex items-center gap-4">
            <a href="https://www.facebook.com/OlivosCartagena" target="_blank" rel="noopener noreferrer" aria-label="Facebook" style={{ color: SOL_TEAL }} className="hover:opacity-70 transition-opacity">
            ...
            <a href="https://www.instagram.com/olivos.ctg" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ color: SOL_TEAL }} className="hover:opacity-70 transition-opacity">
            ...
            <a href="tel:3232641770" className="flex items-center gap-2 text-white text-base font-bold px-6 py-3 rounded-full transition-opacity hover:opacity-90" style={{ background: SOL_TEAL }}>
